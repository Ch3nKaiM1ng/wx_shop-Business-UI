        ...
        <el-table :data="tableData" style="width: 100%">
          ...
          <el-table-column label="操作" width="360" align="center">
            <template slot-scope="scope">
              ...
              <el-button size="mini" type="primary" @click="commentEdit(scope.$index, scope.row)">二级评论</el-button>
...
export default {
  ...
  methods: {
    ...
    commentEdit(a, b) {
      this.$router.push({
        path: '/case/TwoComment',
        query: { id: b.id, caseId: b.caseId, receiveUserId: b.userId }
      })
    },
    handleDelete(a, b) {
